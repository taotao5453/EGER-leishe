...
var GameOverPanel = (function (_super) {
    ...
    GameOverPanel.prototype.initPanel = function () {
        ...
        var t_scale = this.w / this.shareCover.width;
        ...
        var t_str = "您完成今日行走任务，并结识了" + MyGameConfig.friend_number + "个NABU好友。带上NABU，让我们一起为健康努力！";
    ...
    GameOverPanel.prototype.playAgainHandler = function (e) {
    ...
    GameOverPanel.prototype.lingquHandler = function (e) {
